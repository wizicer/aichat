...
- 支持分类筛选
- 新建/编辑/删除条目
- 快速添加预设模板（现代都市、魔法学院、末世废土、古代东方、亲密关系等）
...
#### 3.4.3 设置
- **API设置**
  - API提供商选择（OpenAI/Gemini/DeepSeek/Moonshot/自定义）
  - API端点URL
  - API密钥
  - 模型选择
  - 测试连接按钮
